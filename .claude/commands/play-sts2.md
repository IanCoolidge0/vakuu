...
Each turn:
1. `curl http://localhost:58232/game/state` — returns JSON describing the current screen (combat, map, event, shop, rest, treasure, card_reward, rewards, card_select, hand_select, ancient, game_over).
